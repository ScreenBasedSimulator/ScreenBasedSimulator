...
public class ScoreDP {
     ...
     *
     * Suggestion given by Victor:
     * 	These variables may be better if they are non-static.
     */
    ...
    /**
     * Main function of scoreDP class, The method will receive two parameters
     * one is the Golden Standard Path, another is the real Path from the user
     *
     */
    ...
    /**
     * The method that is used to return the matched steps between scored path and golden standard.
     *
     * @return
     * 		The concatenate step in String type. Seperated by ",".
     * @throws Exception
     */
...
>>>>>>> 72d4d3c131403581912a091b1627a0cb1ffbe96d
}
