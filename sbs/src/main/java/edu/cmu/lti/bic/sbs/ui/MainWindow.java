...
public class MainWindow {
	...
	/**
	 * Create the application, pass in ui parameter and initialize the main
	 * window.
	 * 
	 * @param ui
	 *          user interface
	...
	/**
	 * Initialize the contents of the main window and sets up the clock, patient,
	 * tool, nurse and pathography panel.
	 * 
	 * @throws IOException
	 * @throws HeadlessException
	 */
	 ...
	 * 
	 * @param basic
	 *          gives out patient's basic information
	 * @param description
	 *          gives out the disease description about the patient
	 */
	 ...
	 * 
	 * @param record
	 *          the record we want to add to the panel
	 */
	 ...
	 *          the lower bound of blood pressure
	 * @param systolicBloodPressure
	 *          the upper bound of blood pressure
	 * @param heartRate
	 *          the heart rate of the patient
	 * @param oxygenLevel
	 *          the oxygen level of the patient
	...
	public void setMonitor(Double diastolicBloodPressure,
		...
		monitorPanel
				.setBloodPressure(systolicBloodPressure, diastolicBloodPressure);
